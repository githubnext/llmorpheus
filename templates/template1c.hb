...
{{{orig}}}
```
Please consider using different variables, object properties, functions, or methods.  
Please also consider introducing additional safety checks, or removing existing ones.
