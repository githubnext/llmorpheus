...
Please state the three most likely code fragments that the PLACEHOLDER should be replaced with. 
Please do NOT use code fragments that are equivalent to the following code:
<BEGIN>
{{{orig}}}
<END>
