...
describe('big test suite', (): void => {
  ...
  it('sort an empty array of strings', (): void => {
    const sorter: ISorter<string> = new MergeSorter<string>();
  ...
  it('sort an array containing two strings and undefined', (): void => {
    const sorter: ISorter<string | undefined> = new MergeSorter<string | undefined>();
  ...
  it('sort an array containing two numbers', (): void => {
    const sorter: ISorter<number> = new MergeSorter<number>();
  ...
  it('sort an array containing user-defined types', (): void => {
    const sorter: ISorter<Person> = new MergeSorter<Person>();
