...
if (require.main === module) {
  (async () => {
    ...
    const mutantGenerator = new MutantGenerator(argv.rulesFileName, ruleFilter, argv.instructionsFileName, argv.numCompletions, argv.logFileName, argv.removeInvalid);
